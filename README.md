...
-'notebooks/' - Contains the Jupyter notebooks for analysis and model building
...
-GitHub -> For collaboration with team members

libraries used: 

-Pandas -> for handling the datasets

-Scikit-learn -> for SVM, KNN, TF-IDF metrics
